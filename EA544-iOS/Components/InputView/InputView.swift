...
final class InputView: NibDesignable {
    ...
    private var textFieldColor: UIColor {
        return errorMessageLabel.isHidden ? .darkText : .red
    }
...
//        textField.layer.borderWidth = isEditable ? 2 : 0
    ...
    override func setTheme() {
        ...
        textField.textColor = textFieldColor
        textField.backgroundColor = #colorLiteral(red: 0.9411764706, green: 0.9411764706, blue: 0.9411764706, alpha: 1)
        textField.layer.borderColor = errorMessageLabel.isHidden ? UIColor.darkText.cgColor : UIColor.red.cgColor
        textField.attributedPlaceholder = NSAttributedString(string: textField.placeholder ?? "",
                                                             attributes: [.foregroundColor : #colorLiteral(red: 0.5490196078, green: 0.5490196078, blue: 0.5490196078, alpha: 1)])
